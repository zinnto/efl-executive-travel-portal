...
function createTripCard(trip, statusLabel){
...
function displayExecutive(){
    ...
    container.innerHTML = `
        ...
        ${currentTrips.length ?
            ...
            currentTrips.map(trip => createTripCard(trip, "🟢 Current")).join("")
        ...
        ${upcomingTrips.length ?
            ...
            upcomingTrips.map(trip => createTripCard(trip, "🔵 Upcoming")).join("")
        ...
        ${historyTrips.length ?
            ...
            historyTrips.map(trip => createTripCard(trip, "⚪ Completed")).join("")
...
Jasmine.onReady(displayExecutive);
